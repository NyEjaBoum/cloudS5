...
public class SignalementCpl {
    ...
    private Integer niveau; // ✅ Nouveau champ
    ...
    public SignalementCpl(Integer id, String titre, String description, Integer statut,
    ...
    public SignalementCpl(Integer id, String titre, String description, Integer statut,
                         BigDecimal latitude, BigDecimal longitude, BigDecimal surfaceM2, BigDecimal budget,
                         Integer niveau, Integer idEntreprise, String entreprise, String entrepriseAdresse, String entrepriseContact,
                         Integer idUtilisateur, String utilisateurNom, String utilisateurPrenom, String utilisateurEmail,
                         String dateCreation, Integer avancementPourcent) {
        this(id, titre, description, statut, latitude, longitude, surfaceM2, budget,
             idEntreprise, entreprise, entrepriseAdresse, entrepriseContact,
             idUtilisateur, utilisateurNom, utilisateurPrenom, utilisateurEmail,
             dateCreation, avancementPourcent);
        this.niveau = niveau;
    }
